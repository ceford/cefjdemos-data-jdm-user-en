...
![Feed display module data entry](../../../en/images/news-feeds/news-display/01-news-joomla-news-form.png)

The result can be ugly but can be improved with some custom styles in user.css:

![Feed display module data entry](../../../en/images/news-feeds/news-display/02-news-joomla-news-display.png)
...
![NewsFeed component data entry](../../../en/images/news-feeds/news-display/03-news-feed-data-entry.png)
...
![NewsFeed menu item data entry](../../../en/images/news-feeds/news-display/04-news-feed-menu-form.png)

Test it: go to the Site menu and select the Feed menu item.

![NewsFeed display](../../../en/images/news-feeds/news-display/05-news-feed-display.png)
...
![NewsFeed custom display](../../../en/images/news-feeds/news-display/06-news-feed-custom-display.png)
...
![News feed by category menu form](../../../en/images/news-feeds/news-display/07-news-feed-menu-category-form.png)
