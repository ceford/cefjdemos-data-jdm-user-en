...
the Joomla Community Magazine: <a
href="https://magazine.joomla.org/all-issues/october-2025/laragon-the-effortless,-high-performance-amp-server-for-windows"
target="_blank" rel="noopener">Laragon: The Effortless, High-Performance
AMP Server for Windows</a>.
...
href="https://github.com/leokhoa/laragon/releases/download/8.6.1/laragon-wamp.exe"
class="ng-star-inserted" target="_blank" rel="noopener"
data-hveid="6">click here to download the installer directly</a>.
...
\
<img src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/image1.png"
decoding="async" loading="lazy"
data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/image1.png"
width="1849" height="795" />
...
2.  **Setup Options:** Make sure the **Auto virtual hosts** checkbox is
    ...
    clean address (like <a href="http://myjoomla.test"
    class="underline underline-offset-2 decoration-1 decoration-current/40 hover:decoration-current focus:decoration-current">http://myjoomla.test</a>)
    instead of a raw IP address.\
    \
    <img
    src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/img5laragon.jpeg"
    decoding="async" loading="lazy"
    data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/img5laragon.jpeg"
...
<img
src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/image3Laragon.png"
decoding="async" loading="lazy"
data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/image3Laragon.png"
...
1.  The main **License Key** window will appear over your Laragon
    interface. Click the **Close** text or the 'X'.\
    <img
    src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/image4Laragon.png"
    decoding="async" loading="lazy"
    data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/image4Laragon.png"
    width="1016" height="608" />\
    \
...
2.  Immediately after closing it, a second **Warning** pop-up will
    ...
    Click **OK** or the 'X'.\
    <img
    src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/image5Laragon.png"
    decoding="async" loading="lazy"
    data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/image5Laragon.png"
    width="1021" height="611" />
    \
    \
...
4.  Click the **Open** button at the bottom.\
    \
    **Troubleshooting: "Access denied for user 'root'@'localhost'"
    ...
    (Port 3306).\
    <img
    src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/image6Laragon.jpeg"
    decoding="async" loading="lazy"
    data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/image6Laragon.jpeg"
    width="1022" height="635" />\
    \
    ...
    **The Fix:**
    ...
    2.  Scroll down the list to find **MySQL**, **MySQL80**, or
        **MariaDB**.
...
- Head over to the official
  <a href="https://downloads.joomla.org/" class="ng-star-inserted"
  target="_blank" rel="noopener" data-hveid="0"
  data-ved="0CAAQ_4QMahgKEwjotfCptr2TAxUAAAAAHQAAAAAQhwE">Joomla download
  page</a> and download the latest **Full Package** `.zip` file.
...
- **The PR Prebuilt Package:** Alternatively, if you are testing a
  ...
  **Show all checks**, and look for the **Download Prebuilt packages**
  link.\
  <img
  src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/image7Laragon.png"
  decoding="async" loading="lazy"
  data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/image7Laragon.png"
  width="1078" height="543" />
...
- Clone the
  <a href="https://github.com/joomla/joomla-cms" class="ng-star-inserted"
  target="_blank" rel="noopener" data-hveid="0"
  data-ved="0CAAQ_4QMahgKEwjotfCptr2TAxUAAAAAHQAAAAAQiQE">Joomla CMS
  GitHub repository</a> directly into your Laragon environment using
  Git.
...
4.  Because you enabled "Auto virtual hosts" during installation,
    ...
    **Tip: Keep Your Environments Clean:** It is a good idea to create
    ...
    <img
    src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/image8Laragon.png"
    decoding="async" loading="lazy"
    data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/image8Laragon.png"
    width="874" height="449" />\
    \
    \
...
5.  On the **Database Configuration** screen, enter the credentials for
    ...
    - **Database Name:** The exact name you typed into HeidiSQL earlier
      (e.g., `joomla_dev`). \
      <img
      src="/images/users/88451937-0231-4ce5-8d8d-1791c1202ab4/image9Laragon.png"
      decoding="async" loading="lazy"
      data-path="restrictedfs-88451937-0231-4ce5-8d8d-1791c1202ab4:/image9Laragon.png"
      width="1897" height="856" />
