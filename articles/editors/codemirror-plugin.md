...
![Code mirror plugin settings](../../../en/images/editors/codemirror-plugin/01-codemirror-plugin-tab.png)

The following screenshot shows HTML colour highlighting and the *CMS Content*
implemented as a row of buttons:

![Code mirror in use](../../../en/images/editors/codemirror-plugin/02-codemirror-example.png)
